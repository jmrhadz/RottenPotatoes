...
//   let newPerson = new Person('Kristina', 'Comedy');
  ...
  class MovieService {
    ...
    filterMovies(){
        ...
        for(let movie of availMovies){
            ...
            //check if userGenre is in movieGenre, and push it to filtered movies if so
        ...
        console.log('remaining catalog:',this.remainingCatalog);
    }
        ...
        document.getElementById('map-movies').innerHTML = this.filteredMovies.map(
            ...
            <div class="card m-4">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="mb-2">${movie.dateReleased}</div>
                    <div class="mb-2">${movie.genre}</div>
                    <div class="mb-2">${movie.ageRating}</div>
                </div>
            </div>
            `
            ).join("")
